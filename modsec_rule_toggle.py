...
MONITOR_RULES_FILE = "/etc/nginx/modsec/coreruleset-4.17.1/rules/RESPONSE-999-CUSTOM-RULES.conf"
DISABLED_RULES_FILE = "/etc/nginx/modsec/coreruleset-4.17.1/rules/REQUEST-900-EXCLUSION-RULES-BEFORE-CRS.conf"
...
def test_crs_configuration():
    ...
    try:
        ...
        crs_setup_path = "/etc/nginx/modsec/coreruleset-4.17.1/crs-setup.conf"
